"""Connectivity binary sensor for ha_aftership."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.ha_aftership.entity import AftershipEntity
...
class AftershipConnectivitySensor(BinarySensorEntity, AftershipEntity):
    """Connectivity sensor for ha_aftership."""
