"""
Custom integration to integrate ha_aftership with Home Assistant.
...
https://github.com/myztillx/ha-aftership
...
from .data import AftershipData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import AftershipConfigEntry
...
async def async_setup_entry(
    ...
    1. User enters api_key in config flow (config_flow.py)
    2. Credentials stored in entry.data[CONF_API_KEY]
    ...
    client = AftershipApiClient(hass, entry.data[CONF_API_KEY])
    ...
    # Store runtime data
    entry.runtime_data = AftershipData(
        client=client,
