...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/myztillx/ha-aftership?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=ha-aftership&category=integration)
...
1. Download the `custom_components/ha_aftership/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=ha_aftership)
...
Find all entities in **Settings** → **Devices & Services** → **Aftership** → click on the device.
...
```yaml
service: ha_aftership.example_action
data:
  # Add your parameters here
```

### `ha_aftership.reload_data`
...
```yaml
service: ha_aftership.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.ha_aftership: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Aftership → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@myztillx][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/myztillx/ha-aftership.svg?style=for-the-badge
[commits]: https://github.com/myztillx/ha-aftership/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/myztillx/ha-aftership.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40myztillx-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/myztillx/ha-aftership.svg?style=for-the-badge
[releases]: https://github.com/myztillx/ha-aftership/releases
