...
- **Domain:** `ha_aftership`
- **Title:** Aftership
- **Repository:** myztillx/ha-aftership

**Key directories:**

- `custom_components/ha_aftership/` - Main integration code
...
- Integration logs: `custom_components.ha_aftership: debug` in `config/configuration.yaml`
...
- **Domain:** `ha_aftership`
- **Title:** Aftership
- **Class prefix:** `Aftership`

**When creating new files:**

- Use the domain `ha_aftership` for all DOMAIN references
- Prefix all integration-specific classes with `Aftership`
- Use "Aftership" as the display title
...
- Inherit from platform base + `AftershipEntity`
...
- `tests/` mirrors `custom_components/ha_aftership/` structure
