# Getting Started with Aftership

This guide will help you install and set up the Aftership custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/myztillx/ha-aftership`
6. Set category to "Integration"
7. Click "Add"
8. Find "Aftership" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/myztillx/ha-aftership/releases)
2. Extract the `ha_aftership` folder from the archive
3. Copy it to `custom_components/ha_aftership/` in your Home Assistant configuration directory
...
4. Select entities from "Aftership"
...
- Report issues at [GitHub Issues](https://github.com/myztillx/ha-aftership/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/myztillx/ha-aftership/discussions)
