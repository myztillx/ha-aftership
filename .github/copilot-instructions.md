...
- **Main code:** `custom_components/ha_aftership/`
...
- `entity/` — Base entity class (`AftershipEntity`)
...
- Entity MRO: `(PlatformEntity, AftershipEntity)` — order matters
...
- Debug level: `custom_components.ha_aftership: debug` in `config/configuration.yaml`
